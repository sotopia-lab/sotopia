...
class AgentSession:
    def __init__(self) -> None:
        ...
        self.recent_actions: deque[ActionType] = deque(maxlen=3)  # Track the last 3 actions
    ...
    def print_status(self) -> None:
        ...
        recent_actions_report = ", ".join([action.value for action in self.recent_actions])  # Convert ActionType to str
