    ...
    try:
        if script_like:
            ...
            template = """
                ...
                Note: If you set the `to` field, the action becomes "private". Private messages are visible only to the recipients. The recipients must be a subset of the participants, excluding yourself.
