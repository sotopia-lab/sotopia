...
#     """Just builds next observations from actions. Environment would handle the rest."""

#     def process(self, env: Any, actions: Dict[str, Any]):
#         # Record actions (env already has this via recv_message)
#         for agent, action in actions.items():
#             env.recv_message(agent, action)
#             logging.debug(f"Agent {agent} performed action: {action}")

#         # Build the next observations
#         observations = {}
