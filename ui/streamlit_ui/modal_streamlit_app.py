...
image = (
    ...
    .run_commands(
        "rm -rf sotopia && git clone https://github.com/sotopia-lab/sotopia.git && cd sotopia && git checkout demo && uv pip install pyproject.toml --system && git status && pip install -e . && cd ui && cd streamlit_ui"
    )
