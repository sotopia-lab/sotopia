...
async def main() -> None:
    await run_async_server(
        model_dict={
            "env": "custom/google/gemma-3-27b@http://127.0.0.1:1234/v1",
            "agent1": "custom/qwen/qwen3-1.7b@http://127.0.0.1:1234/v1",
            "agent2": "custom/qwen/qwen3-1.7b@http://127.0.0.1:1234/v1",
        },
        sampler=sampler,
    )
