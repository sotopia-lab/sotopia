...
ap1_goal = "You goal is to collaborate with AI agent in the working space." +  " <extra_info>" + ap1_scenario["extra_info"] + "</extra_info>" + " <strategy_hint>" + ap1_scenario["strategy_hint"] + "</strategy_hint>"

ap2_goal = "You goal is to collaborate with AI agent in the working space." +  " <extra_info>" + ap2_scenario["extra_info"] + "</extra_info>" + " <strategy_hint>" + ap2_scenario["strategy_hint"] + "</strategy_hint>"
