...
def test_simulator(mock_redis):
    ...
    with patch('sotopia.api.websocket_utils.EnvironmentProfile.get', side_effect=Exception), \
         patch('sotopia.api.websocket_utils.AgentProfile.get', side_effect=Exception), \
