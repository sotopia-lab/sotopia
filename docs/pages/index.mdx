...
<span className="font-display text-xl">Sotopia</span> is a platform for simulating, evaluating, training and deploying AI agents in human-involved multi-agent environments.
...
There are two ways to setup the package: automatic installation and manual setup.

### Automatic Installation
```bash
pip install sotopia
sotopia install # an interative installer
